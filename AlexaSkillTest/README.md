...
This is a sample template for AlexaSkillTest - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name alexaskilltest --query 'Stacks[].Outputs'
```
